...
'tie_breaker_description' => totranslate("Number of action and wild cards in the discard pile. If it's a tie, then this is the sum of numeric discarded cards."),
